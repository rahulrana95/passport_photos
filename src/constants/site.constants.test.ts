...
describe('site copy invariants', () => {
  const allCopy = [SITE_NAME, SITE_TAGLINE, SITE_DESCRIPTION, ACCEPTANCE_DISCLAIMER];
  ...
  it('states that the authority makes the final decision', () => {
    expect(ACCEPTANCE_DISCLAIMER.toLowerCase()).toContain('final decision');
  });
